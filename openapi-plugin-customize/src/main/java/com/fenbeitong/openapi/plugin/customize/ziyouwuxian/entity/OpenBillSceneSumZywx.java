...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "open_bill_scene_sum_zywx")
public class OpenBillSceneSumZywx {
     ...
     * 火车票退票改签费用
     */
    @Column(name = "TRAIN_REFUND_INSURANCE_SUM")
    private BigDecimal trainRefundInsuranceSum;
     ...
     * 机票退票改签费用
     */
    @Column(name = "AIR_REFUND_INSURANCE_SUM")
    private BigDecimal airRefundInsuranceSum;
