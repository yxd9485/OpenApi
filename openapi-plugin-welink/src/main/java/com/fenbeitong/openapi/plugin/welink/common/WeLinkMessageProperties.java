 ...
 */
@Slf4j
public class WeLinkMessageProperties {
    ...
    static {
        ...
        try {
            ClassPathResource resource = new ClassPathResource("prop/welink.message.properties");
    ...
    public static String getProperty(String key) {
        return pro.getProperty("welink.msg." + key);
    }
}
