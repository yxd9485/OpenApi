...
@Component
@Slf4j
public class WeLinkIsvCorpAuthProcessor extends AbstractTaskProcessor {
    ...
    public Integer getTaskType() {
        return TaskType.WELINK_ISV_CORP_AUTH.getCode();
    }

    @Override
    public TaskProcessResult process(FinhubTask task) {
        String corpId = task.getCompanyId();
        weLinkIsvCompanyAuthService.companyAuthTrial(corpId, null);
