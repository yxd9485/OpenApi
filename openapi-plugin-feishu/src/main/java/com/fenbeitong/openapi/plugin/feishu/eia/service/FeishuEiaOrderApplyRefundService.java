...
@ServiceAspect
@Service
public class FeishuEiaOrderApplyRefundService implements IFeishuProcessApplyService {
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition feishuCorp, ThirdApplyDefinition apply, FeiShuApprovalRespDTO.ApprovalData approvalData) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyApplyRefundAgree(corpId, dataId, OpenType.FEISHU_EIA.getType());
        if (fbtOrderApply) {
