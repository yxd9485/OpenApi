...
public class WeChatIsvAppPushHandler extends EventHandler<AppPushEvents> {
    ...
    @WebAppEvent(type = "app", version = "1.0", value = 3)
    @Override
    public boolean process(AppPushEvents appPushEvents, Object... args) {
        weChatIsvMessageService.pushMessage(appPushEvents);
        return true;
    }
}
