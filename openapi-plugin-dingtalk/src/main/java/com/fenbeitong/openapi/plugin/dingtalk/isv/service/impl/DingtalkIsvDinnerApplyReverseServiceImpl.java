...
@Slf4j
@Component
public class DingtalkIsvDinnerApplyReverseServiceImpl extends AbstractDingtalkIsvApplyService {
    ...
    public TaskResult processApply(OpenSyncBizDataMedium task, DingtalkIsvCompany dingtalkIsvCompany, DingtalkApply apply, OapiProcessinstanceGetResponse.ProcessInstanceTopVo processInstanceTopVo) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyDinnerApplyAgree(corpId, dataId, OpenType.DINGTALK_ISV.getType());
        if (fbtOrderApply) {
