...
@ServiceAspect
@Service
public class FeiShuMallReverseApplyServiceImpl extends AbstractApplyReverseService implements FeishuProcessReverseApplyService {

    @Override
    protected String getCategory() {
        return ApplyOrderCategory.MALL.getCategory();
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        ApplyProcessReverseFactory.registerHandler(ProcessTypeConstant.MALL_REVERSE , this );
    }
