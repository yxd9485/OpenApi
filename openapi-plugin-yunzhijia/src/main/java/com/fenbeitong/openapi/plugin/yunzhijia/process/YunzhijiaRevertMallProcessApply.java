...
@ServiceAspect
@Service
public class YunzhijiaRevertMallProcessApply extends AbstractApplyService implements IYunzhijiaProcessApply {
    ...
    public TaskResult processApply(Task task, ThirdApplyDefinition thirdApplyDefinition, PluginCorpDefinition apply, YunzhijiaApplyEventDTO.YunzhijiaApplyData yunzhijiaApplyData) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyMallApplyAgree(corpId, dataId, OpenType.YUNZHIJIA.getType());
        if (fbtOrderApply) {
