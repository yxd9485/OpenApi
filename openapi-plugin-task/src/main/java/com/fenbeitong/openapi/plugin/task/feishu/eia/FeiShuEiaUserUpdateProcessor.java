...
@Component
@Slf4j
public class FeiShuEiaUserUpdateProcessor extends AbstractTaskProcessor {
    ...
    @Autowired
    private FeiShuEiaUserAddProcessor feiShuEiaUserAddHandler;
    ...
    public Integer getTaskType() {
        return TaskType.FEISHU_EIA_UPDATE_USER.getCode();
    }
    ...
    public TaskProcessResult process(FinhubTask task) {
        ...
        if (srcEmployeeList == null || srcEmployeeList.size() == 0) {
            return feiShuEiaUserAddHandler.process(task);
        }
        //6.转换人员
