...
@ServiceAspect
@Service
public class FeiShuOrderReverseApplyChangeServiceImpl extends AbstractApplyReverseService implements FeishuProcessReverseApplyService {
    ...
    public void afterPropertiesSet() throws Exception {
        ApplyProcessReverseFactory.registerHandler(ProcessTypeConstant.CHANGE_REVERSE , this );
    }
