...
@Component
@Slf4j
public class WeChatOrderChangeEiaProcessApply extends AbstractWeChatEiaEiaProcessApply implements IWeChatEiaProcessApply {
    @Autowired
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition corp, ThirdApplyDefinition apply, WeChatApprovalDetail.WeChatApprovalInfo weChatApprovalInfo) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyApplyChangeAgree(corpId, dataId, OpenType.WECHAT_EIA.getType());
        if (fbtOrderApply) {
