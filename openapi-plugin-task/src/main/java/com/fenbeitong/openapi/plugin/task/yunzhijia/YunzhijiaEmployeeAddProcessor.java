...
@Component
@Slf4j
public class YunzhijiaEmployeeAddProcessor extends YunzhijiaEmployeeHandler implements ITaskProcessor {
    ...
    public Integer getTaskType() {
        return TaskType.YUNZHIJIA_USER_ADD_ORG.getCode();
    }
    ...
    public TaskProcessResult process(FinhubTask task) {
        ...
        if (ObjectUtils.isEmpty(yunzhijiaEmployeeDetail) || ObjectUtils.isEmpty(yunzhijiaEmployeeDetail.getData())) {
            return TaskProcessResult.success("expired success");
        }
        //5.拼装分贝通请求参数
        //分贝通公司ID
