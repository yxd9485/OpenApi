 ...
 */
@Slf4j
public class DingtalkMessageProperties {
    ...
    static {
        ...
        try {
            ClassPathResource resource = new ClassPathResource("prop/dingtalk.message.properties");
    ...
    public static String getProperty(String key) {
        return pro.getProperty("dingtalk.msg." + key);
    }
}
