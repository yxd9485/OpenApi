...
@Component
@Slf4j
public class WeChatTripEiaProcessApply extends AbstractWeChatEiaEiaProcessApply implements IWeChatEiaProcessApply {
    @Autowired
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition corp, ThirdApplyDefinition apply, WeChatApprovalDetail.WeChatApprovalInfo weChatApprovalInfo) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyApplyAgree(corpId, dataId, OpenType.WECHAT_EIA.getType());
        if (fbtOrderApply) {
