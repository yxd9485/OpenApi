...
@ServiceAspect
@Service
public class FeishuEiaOrderApplyReverseService implements IFeishuProcessApplyService {
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition feishuCorp, ThirdApplyDefinition apply, FeiShuApprovalRespDTO.ApprovalData approvalData) {
        ...
        boolean fbtOrderApply = commonApplyService.createFbtOrderApply(corpId, dataId, OpenType.FEISHU_EIA.getType());
        if (fbtOrderApply) {
