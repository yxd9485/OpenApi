...
@ServiceAspect
@Service
public class FeishuEiaOrderApplyChangeService implements IFeishuProcessApplyService {
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition feishuCorp, ThirdApplyDefinition apply, FeiShuApprovalRespDTO.ApprovalData approvalData) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyApplyChangeAgree(corpId, dataId, OpenType.FEISHU_EIA.getType());
        if (fbtOrderApply) {
