...
@ServiceAspect
@Service
public class YunzhijiaRevertDinnerProcessApply extends AbstractApplyService implements IYunzhijiaProcessApply {
    ...
    public TaskResult processApply(Task task, ThirdApplyDefinition thirdApplyDefinition, PluginCorpDefinition apply, YunzhijiaApplyEventDTO.YunzhijiaApplyData yunzhijiaApplyData) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyDinnerApplyAgree(corpId, dataId, OpenType.YUNZHIJIA.getType());
        if (fbtOrderApply) {
