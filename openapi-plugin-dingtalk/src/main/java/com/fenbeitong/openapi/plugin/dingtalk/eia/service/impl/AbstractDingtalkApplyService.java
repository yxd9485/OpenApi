 ...
 */
@Component
public abstract class AbstractDingtalkApplyService extends AbstractCarApplyService implements IDingtalkProcessApplyService   {

    @Autowired
    private DingtalkProcessInstanceDao dingtalkProcessInstanceDao;

    protected void saveDingtalkProcessInstance(Task task, DingtalkApply apply, OapiProcessinstanceGetResponse.ProcessInstanceTopVo processInstanceTopVo) {
        // 记录审批实例信息
