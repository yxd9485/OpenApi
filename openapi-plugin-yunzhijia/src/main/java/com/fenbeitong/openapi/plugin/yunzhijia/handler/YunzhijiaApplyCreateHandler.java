...
@Component
@Slf4j
public class YunzhijiaApplyCreateHandler implements ITaskHandler {
    @Autowired
    ...
    public TaskType getTaskType() {
        return TaskType.YUNZHIJIA_APPROVE_CREATE;
    }
    ...
    public TaskResult execute(Task task) {
        ...
        TaskResult taskResult = processApply.processApply(task, thirdApplyDefinitionById, pluginCorpByCorpId, applyData);
        return taskResult;
    }
}
