...
@Component
@Slf4j
public class FxiaokeApprovalTripHandler extends AbstractTripApplyService implements ITaskHandler {
    ...
    @Autowired
    FxiaokeApplyTripDao fxiaokeApplyTripDao;
    @Autowired
    FxiaokeTripRoundDao fxiaokeTripRoundDao;


    @Override
    public TaskType getTaskType() {
        return TaskType.FXIAOKE_APPROVE_TRIP_CREATE;
    }
