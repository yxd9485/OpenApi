package com.fenbeitong.openapi.plugin.customize.neocrm.ningboweili.handle;
...
@Component
@Slf4j
public class NingBoWeiLiTripApplyCreateHandler extends AbstractTripApplyService implements ITaskHandler {
    ...
    @Autowired
    NingBoWeiLiCarServiceImpl ningBoWeiLiCarService;

    @Override
    public TaskType getTaskType() {
        return TaskType.NINGBOWEILI_TRIP_APPLY_CREATE;
    }
    ...
    public TaskResult execute(Task task) {
        ...
        if (pluginCorpDefinition == null) {
            ...
            throw new OpenApiPluginSupportException(SupportRespCode.APPLY_CREATE_ERROR, "企业不存在，任务丢弃");
        }
