...
@ServiceAspect
@Service
public class FeishuEiaTripApplyReverseService implements IFeishuProcessApplyService {
    ...
    public TaskResult processApply(Task task, PluginCorpDefinition feishuCorp, ThirdApplyDefinition apply, FeiShuApprovalRespDTO.ApprovalData approvalData) {
        ...
        boolean fbtOrderApply = commonApplyService.notifyApplyAgree(corpId, dataId, OpenType.FEISHU_EIA.getType());
        if (fbtOrderApply) {
