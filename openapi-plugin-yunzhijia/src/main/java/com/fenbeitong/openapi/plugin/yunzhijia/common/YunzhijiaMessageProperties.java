 ...
 */
@Slf4j
public class YunzhijiaMessageProperties {
    ...
    static {
        ...
        try {
            ClassPathResource resource = new ClassPathResource("prop/yunzhijia.message.properties");
    ...
    public static String getProperty(String key) {
        return pro.getProperty("yunzhijia.msg." + key);
    }
}
